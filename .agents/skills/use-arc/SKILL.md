---
name: use-arc
description: Chain config, RPC setup, contract deployment, USDC bridging, gas with USDC, App Kit, and Arc platform integration instructions for AI agents building on Arc Layer-1 blockchain.
---

# Arc — Programmable Money Blockchain
...
## Getting Started — Chain Config & Overview

| Product | Skill | What it covers |
|---------|-------|----------------|
| Arc | `use-arc` | Chain config, RPC setup, contract deployment, USDC bridging, gas with USDC |
...
5. **Testnet.** Arc is currently available on Testnet only. [Connect to Arc](https://docs.arc.io/arc/references/connect-to-arc.md) for RPC endpoints. Use [Faucet](https://faucet.circle.com) for testnet tokens.
